...
public class MainActivity extends Activity implements OnCompletionListener, SeekBar.OnSeekBarChangeListener {
	...
	public void initFetchSongLists()
	{
		mProgressDialog = ProgressDialog.show(MainActivity.this, null, null);
		mProgressDialog.setContentView(R.layout.progress_loader);
		mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
		mProgressDialog.setCancelable(false);
		new FetchListManager(context).GetAllSongList(new CallBackManager()
		{
			@Override
			public void onSuccess(String responce)
			{
				mProgressDialog.dismiss();
				Log.i("respo_status",""+responce.toString());
				if(responce.toString().equalsIgnoreCase(Constant.Messages.SERVER_RESPONCE))
				{
					Snackbar snackbar = Snackbar.make(linear, ""+responce.toString(), Snackbar.LENGTH_LONG);
					View view = snackbar.getView();
					TextView tv = (TextView) view.findViewById(android.support.design.R.id.snackbar_text);
					tv.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
					FrameLayout.LayoutParams params = (FrameLayout.LayoutParams)view.getLayoutParams();
					params.gravity = Gravity.BOTTOM|Gravity.CENTER|Gravity.CENTER_VERTICAL;
					params.width = FrameLayout.LayoutParams.MATCH_PARENT;
					view.setLayoutParams(params);
					snackbar.show();
				}
				else {
                    songsList=new AllPackageManager(getApplicationContext()).getSongList();
					Log.i("respo_getSongsLst_size=",""+songsList.size());
...
*/
			...
			public void onFailure(String responce) {
				Log.i("responcesf",""+responce.toString());
				mProgressDialog.dismiss();
				InternetStatus= com.utils.Util.isInternetExist(context);
				if (InternetStatus.equalsIgnoreCase("true")) {
					...
					Snackbar snackbar = Snackbar.make(linear, ""+getResources().getString(R.string.internetproblem), Snackbar.LENGTH_LONG);
					View view = snackbar.getView();
					TextView tv = (TextView) view.findViewById(android.support.design.R.id.snackbar_text);
					tv.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
					FrameLayout.LayoutParams params = (FrameLayout.LayoutParams)view.getLayoutParams();
